...
public class VerketteteListe implements Liste {
  ...
  public Comparable loesche_nach(Liste.Iterator i) {
    ...
    if (knoten.nachfolger == null)
      throw new ungueltiger_Iterator_Ausnahme();
    if (knoten.nachfolger == ende)
  ...
  public void verschiebe_an_Anfang(Liste.Iterator iterator) {
    ...
    if (zu_verschieben.nachfolger == null)
      throw new ungueltiger_Iterator_Ausnahme();
    if (zu_verschieben == kopf)
      throw new anfang_Ausnahme();
    if (zu_verschieben == ende)
      throw new ende_Ausnahme();
    Knoten ziel = kopf;
    iterator.weiter();
    if (ziel.nachfolger == zu_verschieben)
      return;
  ...
  public void verschiebe_nach(Liste.Iterator von, Liste.Iterator nach) {
    ...
    if (zu_verschieben == ziel)
      throw new ungueltiger_Iterator_Ausnahme();
    if (ziel.nachfolger == null)
      throw new ungueltiger_Iterator_Ausnahme();
    if (ziel == ende)
      throw new ende_Ausnahme();
    von.weiter();
  ...
  public void verschiebe_nach(Knoten zu_verschieben, Knoten ziel) {
    if (ziel == zu_verschieben)
      return;
    Knoten ziel_nachfolger = ziel.nachfolger;
    if (ziel_nachfolger == zu_verschieben)
      return;
  ...
  public Iterator erzeuge_Iterator(Liste.Iterator iterator) {
    ...
    if (this != vorhandener_iterator.liste)
      throw new ungueltiger_Iterator_Ausnahme();
  ...
  public class Iterator implements Liste.Iterator {
    ...
    public boolean gleich(Liste.Iterator iterator) {
      ...
      if (this.liste != vergleichs_iterator.liste)
        throw new ungueltiger_Iterator_Ausnahme();
    ...
    public Comparable element() {
      if (knoten.nachfolger == null)
        throw new ungueltiger_Iterator_Ausnahme();
      if (knoten == liste.kopf)
        throw new anfang_Ausnahme();
      if (knoten == liste.ende)
        throw new ende_Ausnahme();
